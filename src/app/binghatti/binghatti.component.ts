...
@Component({
  ...
  templateUrl: './binghatti.component.html',
  styleUrl: './binghatti.component.css'
})
export class BINGHATTIComponent {
  ...
  images: any[] = [
...

    {
      ...
      thumb: '/binghatti/image5.jpg',
      alt: 'Image 4',
    },
    {
      full: '/binghatti/image6.jpg',
      thumb: '/binghatti/image6.jpg',
      alt: 'Image 5',
    },
    {
      full: '/binghatti/image7.jpg',
      thumb: '/binghatti/image7.jpg',
      alt: 'Image 5',
    },
    {
      full: '/binghatti/image8.jpg',
      thumb: '/binghatti/image8.jpg',
      alt: 'Image 5',
    },
  ];
  ...
  onSubmit() {
    if (this.contactForm.valid) {
      ...
      this.sendDataService
        .submitContactForm({ ...this.contactForm.value, developer: 'binghatti' })
        .subscribe({
          next: () => {
  ...
  images2 = [
    '/binghatti/image1.jpg',
    '/binghatti/image2.jpg',
    '/binghatti/image5.jpg',
    '/binghatti/image6.jpg',
    '/binghatti/image7.jpg',
    '/binghatti/image8.jpg'
  ];
